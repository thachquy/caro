...
function Loaded()
{
	...
	imgp.style.backgroundImage = "url('Opng.png')";
...
function Click(id)
{
	...
	var path = "url('Opng.png')";
	if (CPlayer == 1) path = "url('Xpng.png')";
	...
	if (!AI)
	{
		...
		var iplayer = "url('Opng.png')";
		if (CPlayer == 1) iplayer = "url('Xpng.png')";
		var imgp = document.getElementById("imgPlayer");
